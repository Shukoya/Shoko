  ...
  describe '#resolve' do
    ...
    context 'when service is not registered' do
      it 'raises DependencyError' do
        ...
        end.to raise_error(EbookReader::Domain::DependencyContainer::DependencyError, "Service 'unknown_service' not registered")
      end
    end
    ...
    context 'when circular dependency exists' do
      it 'raises CircularDependencyError' do
        ...
        end.to raise_error(EbookReader::Domain::DependencyContainer::CircularDependencyError)
      end
    end
  end
