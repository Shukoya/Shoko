...
RSpec.describe EbookReader::Domain::Commands::NavigationCommand do
  ...
  describe 'validation' do
    ...
    it 'requires context with dependencies' do
      ...
      }.to raise_error(EbookReader::Domain::Commands::BaseCommand::ValidationError)
    end
...
RSpec.describe EbookReader::Domain::Commands::ScrollCommand do
  ...
  describe 'validation' do
    it 'validates direction' do
      ...
      }.not_to raise_error # Validation happens at execute time
      
      command = described_class.new(:invalid_direction)
      
      expect {
        command.execute(context)
      }.to raise_error(EbookReader::Domain::Commands::BaseCommand::ValidationError, /Direction must be one of/)
    end
    ...
    it 'validates lines is positive integer' do
      expect {
        ...
        command.execute(context)
      }.to raise_error(EbookReader::Domain::Commands::BaseCommand::ValidationError, /Lines must be a positive integer/)
    end
  end
end
...
RSpec.describe EbookReader::Domain::Commands::JumpToChapterCommand do
  ...
  describe 'validation' do
    it 'validates chapter index is non-negative integer' do
      ...
      expect {
        command.execute(context)
      }.to raise_error(EbookReader::Domain::Commands::BaseCommand::ValidationError, /Chapter index must be a non-negative integer/)
    end
  end
end
