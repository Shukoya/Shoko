    ...
    module Screens
      ...
      class AnnotationTextBox
        ...
        def cursor_position(cursor)
          ...
          cursor_col = TEXT_COLUMN + EbookReader::Helpers::TextMetrics.visible_length(cursor_lines.last || '')
      ...
      class AnnotationEditState
        ...
        def refresh_annotations(service)
          @state.dispatch(
            EbookReader::Domain::Actions::UpdateMenuAction.new(annotations_all: service.list_all)
          )
        end
