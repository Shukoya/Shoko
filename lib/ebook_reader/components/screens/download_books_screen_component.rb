    ...
    module Screens
      ...
      class DownloadBooksScreenComponent < BaseComponent
        ...
        def render_footer(surface, bounds, layout)
          ...
          clipped = EbookReader::Helpers::TextMetrics.truncate_to(hint, layout[:content_width])
        ...
        def safe_text(text)
          EbookReader::Helpers::TerminalSanitizer.sanitize(text.to_s, preserve_newlines: false,
                                                                      preserve_tabs: false)
        end
