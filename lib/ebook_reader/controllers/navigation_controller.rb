...
module EbookReader
  module Controllers
    ...
    class NavigationController
      def initialize(state, doc, page_calculator, dependencies)
        @state = state
        @doc = doc
      ...
      def next_page
        ...
        if @page_calculator && Domain::Selectors::ConfigSelectors.page_numbering_mode(@state) == :dynamic
          max_pages = @page_calculator.total_pages
