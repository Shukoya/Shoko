  ...
  module Application
    ...
    class ReaderApplication
      ...
      def show_error_message(message)
        @dependencies.resolve(:state_store).set(%i[reader message], message)

        # Clear message after 3 seconds
        Thread.new do
          sleep 3
          @dependencies.resolve(:state_store).set(%i[reader message], nil)
        end
      end
      ...
      def initialize_services
        ...
        @dependencies.register_factory(:document_service) do |_container|
      ...
      def setup_event_handlers
        ...
        event_bus.subscribe(self, :state_changed, :bookmark_added, :bookmark_removed,
      ...
      def load_document
        ...
        state_store.update({
                             %i[reader book_path] => @epub_path,
                             %i[reader total_chapters] => document.chapter_count,
                             %i[reader
                                chapter_title] => document.get_chapter(0)&.title || 'Chapter 1',
                           })
      end
      ...
      def render_frame
        ...
        content_bounds = Components::Rect.new(x: 1, y: 1 + header_height, width: width,
        ...
        @footer_component&.render(surface, footer_bounds, @view_model)
      ...
      def load_chapter_content(chapter_index)
        ...
        state_store = @dependencies.resolve(:state_store)
        state_store.set(%i[reader chapter_title], chapter.title)
      end

      def clear_page_cache
        return unless @dependencies.registered?(:page_calculator)
