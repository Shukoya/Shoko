    ...
    class EpubCache
      ...
      module Serializer
        ...
        def sanitize_display(text)
          string = text.to_s
          EbookReader::Helpers::TerminalSanitizer.sanitize(string, preserve_newlines: false, preserve_tabs: false)
        rescue StandardError
          string.to_s
        end
        ...
        def sanitize_content(text)
          string = text.to_s
          EbookReader::Helpers::TerminalSanitizer.sanitize(string, preserve_newlines: true, preserve_tabs: true)
        rescue StandardError
          string.to_s
        end
